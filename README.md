...
| `main` | Reader-facing README, report, notebook, figures, raw evidence, and Space source | Not run as an experiment (publication surface) | Fresh-clone deterministic checks required before publication | Local single-core validation only |
